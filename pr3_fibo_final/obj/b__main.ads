...
package ada_main is
   ...
   u00001 : constant Version_32 := 16#6473ca1c#;
   ...
   u00114 : constant Version_32 := 16#d50c7563#;
   pragma Export (C, u00114, "test_fibonacci_functionsB");
   u00115 : constant Version_32 := 16#fe6142fe#;
   pragma Export (C, u00115, "fibonacci_functionsB");
   u00116 : constant Version_32 := 16#5e39fffe#;
   pragma Export (C, u00116, "fibonacci_functionsS");
   u00117 : constant Version_32 := 16#0dcf11d5#;
   pragma Export (C, u00117, "test_assertionsB");
   u00118 : constant Version_32 := 16#1487d8c5#;
   pragma Export (C, u00118, "test_assertionsS");
   u00119 : constant Version_32 := 16#f28b798a#;
   pragma Export (C, u00119, "use_fiboB");
   u00120 : constant Version_32 := 16#adb6d201#;
   pragma Export (C, u00120, "ada__strings__fixedB");
   u00121 : constant Version_32 := 16#a86b22b3#;
   pragma Export (C, u00121, "ada__strings__fixedS");
   u00122 : constant Version_32 := 16#144f64ae#;
   ...
   --  ada.text_io%s
   --  ada.text_io%b
   --  fibonacci_functions%s
   --  fibonacci_functions%b
   --  use_fibo%b
   --  test_assertions%s
   --  test_assertions%b
   --  test_fibonacci_functions%b
   --  main%b
