...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_test_fibonacci_functions" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#1073bbfd#;
   pragma Export (C, u00001, "test_fibonacci_functionsB");
   ...
   u00114 : constant Version_32 := 16#da653fbf#;
   pragma Export (C, u00114, "fibonacci_functionsB");
   u00115 : constant Version_32 := 16#8cee169a#;
   pragma Export (C, u00115, "fibonacci_functionsS");
